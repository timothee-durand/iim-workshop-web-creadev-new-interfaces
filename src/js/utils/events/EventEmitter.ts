//https://gist.github.com/brunosimon/120acda915e6629e3a4d497935b16bdf?permalink_comment_id=3964343#gistcomment-3964343
...
export class EventEmitter {
	...
	on<T>(_names: string, callback: (payload: T) => void) {
		// Errors
	...
	trigger<T extends unknown>(_name: string, _args?: [T]) {
		// Errors
